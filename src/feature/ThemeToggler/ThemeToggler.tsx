...
const ThemaToggler = () => {
  ...
  const toggleThemeHandler = (e: ChangeEvent<HTMLInputElement>): void => {
    ...
    localStorage.setItem(THEME_LOCAL_STORAGE, updatedTheme);
  };
  ...
  return (
    <label className={s.switch}>
      ...
      <input type="checkbox" className={s.input} onChange={toggleThemeHandler} checked={theme === "dark"} />
